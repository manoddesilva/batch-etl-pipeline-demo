...
function transform(LoanRequest[] loanRequests, LoanApproval[] loanApprovals)
    ...
    join var loanApproval in loanApprovals on loanRequest.loanRequestId equals loanApproval.loanRequestId select transformLoanRequest(loanRequest,loanApproval);
